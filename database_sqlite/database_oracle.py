"""Target database for BAG export"""
import cx_Oracle
import config
import utils
from config_db import ORA_HOST, ORA_SERVICE, ORA_PORT, ORA_USER, ORA_PASS
...
class DatabaseSqlite:
    ...
    def __init__(self):
        ora_pass = ORA_PASS
        ora_dsn = cx_Oracle.makedsn(  # pylint: disable=I1101
            ORA_HOST, ORA_PORT, service_name=ORA_SERVICE
        )
        ora_conn_params = dict(user=ORA_USER, password=ora_pass, dsn=ora_dsn)
        self.connection = cx_Oracle.connect(**ora_conn_params)  # pylint: disable=I1101
